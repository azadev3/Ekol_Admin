...
const LisanseEdit: React.FC = () => {
  ...
  useEffect(() => {
    if (editid) {
      const fetchData = async () => {
        try {
          const response = await axios.get(`${URL}/lisanse/${editid}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.put(`${URL}/lisanse/${editid}`, formData, {
        headers: {
  ...
  return (
    <div className="component-edit">
      <Title description="Dəyişiklik et" title="Lisanslar" to="" />
