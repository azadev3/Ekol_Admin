...
const SocialLifeCarouselEdit: React.FC = () => {
  ...
  useEffect(() => {
    if (editid) {
      const fetchData = async () => {
        try {
          const response = await axios.get(`${URL}/sociallifecarousel/${editid}`, Option());
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.put(`${URL}/sociallifecarousel/${editid}`, formData, OptionWithFormData());
  ...
  return (
    <div className="component-edit">
      <Title description="Dəyişiklik et" title="Sosial Həyat (Karusel hissə)" to="" />
...
export default SocialLifeCarouselEdit;
