    ...
    return (
        <div className='meta-tags-page'>
            <div className='title'>
                ...
                <span>Səhifələr Üçün Əsas Meta Başlıqlar</span>
            </div>
            <p className='mini-title'>Aşağıdan səhifə seçin və uyğun dillərdə əsas "Title" atributlarını doldurun. Bu, səhifələrin browser üzərində sizin istəyinizə uyğun yazılmış başlıqlarla dinamik əvəz ediləcək.</p>
