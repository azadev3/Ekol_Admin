...
const BloqlarDaxili: React.FC = () => {
    ...
    const handleSubmitForm = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const res = await axios.post(`${URL}/meta-titles-bloqlardaxili`, formData, {
                headers: {
    ...
    React.useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`${URL}/meta-titles-bloqlardaxili`);
                if (res.data) {
