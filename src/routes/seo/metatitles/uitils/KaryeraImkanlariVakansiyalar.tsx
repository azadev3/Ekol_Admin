...
const KaryeraImkanlariVakansiyalar: React.FC = () => {
    ...
    const handleSubmitForm = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const res = await axios.post(`${URL}/meta-tags-karyeraimkanlarivakansiyalar`, formData, {
                headers: {
    ...
    React.useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`${URL}/meta-tags-karyeraimkanlarivakansiyalar`);
                if (res.data) {
...
export default KaryeraImkanlariVakansiyalar 