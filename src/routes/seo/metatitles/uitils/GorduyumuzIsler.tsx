...
const GorduyumuzIsler: React.FC = () => {
    ...
    const handleSubmitForm = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const res = await axios.post(`${URL}/meta-titles-gorduyumuzisler`, formData, {
                headers: {
    ...
    React.useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`${URL}/meta-titles-gorduyumuzisler`);
                if (res.data) {
...
export default GorduyumuzIsler 