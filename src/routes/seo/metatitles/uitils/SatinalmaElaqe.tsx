...
const SatinalmaElaqe: React.FC = () => {
    ...
    const handleSubmitForm = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const res = await axios.post(`${URL}/meta-titles-satinalmaelaqe`, formData, {
                headers: {
    ...
    React.useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`${URL}/meta-titles-satinalmaelaqe`);
                if (res.data) {
