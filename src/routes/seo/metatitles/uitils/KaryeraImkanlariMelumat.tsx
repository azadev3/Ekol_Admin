...
const KaryeraImkanlariMelumat: React.FC = () => {
    ...
    const handleSubmitForm = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const res = await axios.post(`${URL}/meta-titles-karyeraimkanlariumumimelumat`, formData, {
                headers: {
    ...
    React.useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`${URL}/meta-titles-karyeraimkanlariumumimelumat`);
                if (res.data) {
...
export default KaryeraImkanlariMelumat 