...
const CobCreate: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${URL}/careerOpportunitiesBackground`, formData, OptionWithFormData());
  ...
  return (
    <div className="component-create">
      <Title description="Əlavə et" title="Kariyera İmkanları - Arxa fon və Başlıq" to="" />
