    ...
    { field: "title_ru", headerName: "Title RU", width: 150 },
    {
      ...
      renderCell: (params) => (
        <div className="buttons-grid">
          <button
            className="edit"
            onClick={() => navigate(`/careerOpportunitiesBackground/${params.row.id}`)} // Navigating to the edit page with the row's id
          >
            Düzəliş
          </button>
          <button
  ...
  return (
    <div className="show-component">
      <Title
        ...
        to="/careerOpportunitiesBackground/create"
      />
