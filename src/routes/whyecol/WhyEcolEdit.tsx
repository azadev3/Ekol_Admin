...
const WhyEcolEdit: React.FC = () => {
    ...
    if (editid) {
      const fetchData = async () => {
        try {
          ...
          setImagePreview(`https://kaiyi-21d4.onrender.com${data.icon}` || "");
  ...
  return (
    <div className="component-edit">
      <Title description="Dəyişiklik et" title="Niyə Ekol? (Kariyera imkanları səhifəsi)" to="" />
