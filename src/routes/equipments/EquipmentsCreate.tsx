...
const EquipmentsCreate: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${URL}/equipments`, formData, {
        headers: {
  ...
  return (
    <div className="component-create">
      <Title description="Əlavə et" title="Avadanlıqlar" to="" />
      <form noValidate autoComplete="off" style={{ marginTop: "16px" }}>
        <TextField
          ...
          margin="normal"
          value={title_az}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => setTitleAz(e.target.value)}
          name="title_az"
        />
        <TextField
          required
        ...
        <TextField
          ...
          margin="normal"
          value={title_ru}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => setTitleRu(e.target.value)}
          name="title_ru"
        />
