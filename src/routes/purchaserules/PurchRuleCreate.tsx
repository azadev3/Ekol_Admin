...
const PurchRuleCreate: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${URL}/purchaserules`, formData, {
        headers: {
  ...
  return (
    <div className="component-create">
      <Title description="Əlavə et" title="Satınalma Qaydaları" to="" />
...
export default PurchRuleCreate;
