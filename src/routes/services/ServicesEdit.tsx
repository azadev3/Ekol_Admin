...
const ServicesEdit: React.FC = () => {
  ...
  useEffect(() => {
    if (editid) {
      const fetchData = async () => {
        try {
          const response = await axios.get(`${URL}/services/${editid}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.put(`${URL}/services/${editid}`, formData, {
        headers: {
  ...
  return (
    <div className="component-edit">
      <Title description="Dəyişiklik et" title="Xidmətlər" to="" />
