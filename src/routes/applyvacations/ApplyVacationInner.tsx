        ...
        <div className="grid-fields">
          ...
          <div className="field-area">
            ...
            <a
              ...
              href={innerApply && innerApply.cv ? `https://kaiyi-21d4.onrender.com${innerApply.cv}` : "#"}
              target="_blank"
          ...
          <div className="field-area">
            ...
            <a
              className="show-cv-button"
              href={innerApply && innerApply.profile ? `https://kaiyi-21d4.onrender.com${innerApply.profile}` : "#"}
              target="_blank"
              rel="noopener noreferrer">
